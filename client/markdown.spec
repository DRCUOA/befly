...
[32m[13] handles mixed markdown pass[0m
 ✓ src/utils/markdown.spec.ts (13 tests) 3ms
...
[32m[8] visibility select has aria-label pass[0m
 ✓ src/components/writing/MetadataPanel.spec.ts (8 tests) 25ms
...
[32m[14] typing is never blocked by typography UI (textarea always accessible) pass[0m
 ✓ src/pages/Write.spec.ts (14 tests) 72ms

 Test Files  3 passed (3)
      Tests  35 passed (35)
   Start at  20:53:30
   Duration  685ms (transform 225ms, setup 22ms, collect 382ms, tests 100ms, environment 264ms, prepare 123ms)
